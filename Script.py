...
‣ вᴜɪʟᴅ ѕᴛᴀᴛᴜѕ: v2.7.1 [ ѕᴛᴀʙʟᴇ ]</b></b>"""
...
<b>ɴᴏᴛᴇ:</b>
 ...
 • /song - ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ sᴏɴɢ [<code>/song OM Deva Deva</code>] 
 • /telegraph - <code>ᴛᴇʟᴇɢʀᴀᴘʜ ɢᴇɴᴇʀᴀᴛᴏʀ sᴇɴ ᴜɴᴅᴇʀ 5MB ᴠɪᴅᴇᴏ ᴏʀ ᴘʜᴏᴛᴏ ɪ ɢɪᴠᴇ ᴛᴇʟᴇɢʀᴀᴘʜ ʟɪɴᴋ</code> 
 • /tts - <code>ᴛᴇxᴛ ᴛᴏ ᴠᴏɪᴄᴇ ᴄᴏɴᴠᴇʀᴛᴇʀ</code> 
 • /video - ᴅᴏᴡɴʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ ɪɴ ʜᴅ [<code>/video https://youtu.be/xyz-k</code>
 • /font - sᴛʏʟɪsʜ ғᴏɴᴛ ɢᴇɴᴇʀᴀᴛᴏʀ [<code>/font hi</code>]"""
...
<b>🏷 𝐓𝐢𝘁𝐥𝐞</b> : <a href={url}>{title}</a>
🎭 𝐆𝐞𝐧𝐫𝐞𝐬 : {genres}
📆 𝐑𝐞𝐥𝐞𝐚𝐬𝐞 𝐈𝐧 : <a href={url}/releaseinfo>{year}</a>
🌟 𝐑𝐚𝐭𝐢𝐧𝐠 : <a href={url}/ratings>{rating}</a> / 10 (based on {votes} user ratings.)
☀️ 𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞𝐬 : <code>{languages}</code>
📀 𝐑𝐮𝐧 𝐓𝐢𝐦𝐞 : {runtime} Minutes
📆 𝐑𝐞𝐥𝐞𝐚𝐬𝐞 𝐈𝐧𝐟𝐨 : {release_date}
🎛 𝐂𝐨𝐮𝐧𝐭𝐫𝐢𝐞𝐬 : <code>{countries}</code></b>"""
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த @Axonn_Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Add This Bot As Administrator In Your Group
 ...
 👇 Add How To Download Button Link 👇
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ @Axonn_Bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस @Axonn_Bot को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ @Axonn_Bot നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس @Axonn_Bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ @Axonn_Bot બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ @Axonn_Bot ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই @Axonn_Bot বট পরিচালনা করুন
...
╰────────────────────⍟"""
    ...
    PLANS = """idhar apne plan ka datails add karna."""
