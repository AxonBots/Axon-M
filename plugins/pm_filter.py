...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Movvies_Request")]])
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("🥀 ᴄʜᴇᴄᴋ ʙᴏᴛ ᴘᴍ 🌴", url=f"https://telegram.me/{temp.U_NAME}")
        ])
    else:
        btn = []
        btn.insert(0, 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await log_msg.reply_text(
                ...
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⭐ ғᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ 🚀", url=lazy_download)],[
                                                    InlineKeyboardButton('🎥 ᴡᴀᴛᴄʜ ᴏɴʟɪɴᴇ 🖥️', url=lazy_stream)]])  # web stream Link
            )
            await query.message.reply_text(
                text="<b>ʏᴏᴜʀ ʟɪɴᴋ ɪs ɢᴇɴᴇʀᴀᴛᴇᴅ...⚡🔥</b>",
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⭐ ғᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ 🚀", url=lazy_download)
                                                   ],[
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
             InlineKeyboardButton(' 💀 ɢᴏᴅ ᴏɴʟʏ 💀', callback_data='admin'),
         ], [ 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 👥', url="https://t.me/+yGNv4jK-wHkzMTc1")
        ],[
            InlineKeyboardButton('❰ ʙᴀᴄᴋ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton("⇊ sᴇʟʟᴇᴄᴛ ʏᴏᴜʀ ᴘʀᴇғᴇʀʀᴇᴅ ʟᴀɴɢᴜᴀɢᴇ ⇊", callback_data="laninfo")
        ], [
            InlineKeyboardButton("ɢᴜᴊʀᴀᴛɪ", callback_data="gujarati_info"),
            InlineKeyboardButton("ᴇɴɢʟɪsʜ", callback_data="english_info"),
            InlineKeyboardButton("ʜɪɴᴅɪ", callback_data="hindi_info")
        ], [
            InlineKeyboardButton("ᴍᴀʟʏᴀʟᴀᴍ", callback_data="malayalam_info"),
            ...
            InlineKeyboardButton("ᴋᴀɴɴᴀᴅ", callback_data="kannada_info"),
